...
import { Listing, ListingType, User } from "../src/database/dbTypes";
...
const users: User[] = [
  {
    _id: new ObjectId("61223a09bb4029b65cb40bd6"),
    username: "ali",
    password: "$2b$10$2DPA4vDOTdP19Ox.70CSEe6qUOa2L359o8pvVj9MXooHTTBsA0f3i",
    permissions: [],
    avatar:
  ...
  {
    _id: new ObjectId("61223ab9bb4029b65cb40bd7"),
    token: "token_************",
    username: "reza",
    password: "$2b$10$pGuP98TnZOpOvqKLkH8X0eoqACP5wngpRVnaYz3XK1wj6g6X5ERA.",
    avatar:
